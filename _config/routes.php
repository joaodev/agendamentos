...
$router['app'] = [
	...
	['namespace' => 'app', 'route' => '/recebimentos', 'controller' => 'revenues', 'action' => 'index'],
	['namespace' => 'app', 'route' => '/recebimentos/cadastrar', 'controller' => 'revenues', 'action' => 'create'],
	['namespace' => 'app', 'route' => '/recebimentos/processa-cadastro', 'controller' => 'revenues', 'action' => 'create-process'],
	['namespace' => 'app', 'route' => '/recebimentos/detalhes', 'controller' => 'revenues', 'action' => 'read'],
	['namespace' => 'app', 'route' => '/recebimentos/editar', 'controller' => 'revenues', 'action' => 'update'],
	['namespace' => 'app', 'route' => '/recebimentos/processa-edicao', 'controller' => 'revenues', 'action' => 'update-process'],
	['namespace' => 'app', 'route' => '/recebimentos/excluir', 'controller' => 'revenues', 'action' => 'delete'],
	['namespace' => 'app', 'route' => '/recebimentos/remove-arquivo', 'controller' => 'revenues', 'action' => 'delete-file'],
	['namespace' => 'app', 'route' => '/recebimentos/cadastrar-cliente', 'controller' => 'revenues', 'action' => 'create-customer'],
