<?php if ($this->view->isAdmin || $this->acl($_SESSION['ROLE'], $this->resourceCodes('view'), $this->moduleCodes('expenses'))): ?>
            ...
            <tbody>
                <?php foreach ($data as $entity): ?>
                    <tr class="text-center" style="cursor: pointer;" 
                        ...
                        <td style="display: none;">
                            <?php echo $entity['customerName'] ? $entity['customerCod'] . ' - ' . $entity['customerName'] : ''; ?>
                        </td> 
                        <td style="display: none;">
                            <?php echo $entity['providerName'] ? $entity['providerCod'] . ' - ' . $entity['providerName'] : ''; ?>
                        </td> 
                        <td style="display: none;">
                            <?php echo $entity['userName'] ? $entity['userCod'] . ' - ' . $entity['userName'] : ''; ?>
                        </td> 
                        <td style="display: none;">
