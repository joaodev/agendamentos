<?php if ($this->view->isAdmin || $this->acl($_SESSION['ROLE'], $this->resourceCodes('view'), $this->moduleCodes('prospects'))): ?>
        ...
        <table class="table table-bordered table-hover" id="table_budgets" style="width: 100%;">
            <thead>
                ...
                <th style="font-size: 14px;">Código</th>
                    ...
                    <td style="display: none;">Telefone</th>
                    <td style="display: none;">Celular</th>
                    <td style="display: none;">Cidade</th>
                    <td style="display: none;">UF</th>
                    <td style="display: none;">Responsável</th>
                    <td style="display: none;">Resultados da Prospecção</th>
