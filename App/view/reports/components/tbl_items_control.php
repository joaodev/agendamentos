<?php if ($this->view->isAdmin || $this->acl($_SESSION['ROLE'], $this->resourceCodes('view'), $this->moduleCodes('items-control'))): ?>
        ...
        <table class="table table-bordered table-hover" id="table_budgets" style="width: 100%;">
            <thead>
                ...
                <th style="font-size: 14px;">Código</th>
                    ...
                    <th style="font-size: 14px;">Produto</th>
                    <th style="font-size: 14px;">Quantidade</th>
                    <th style="font-size: 14px;">Nova Quantidade</th>
            ...
            <tbody>
                <?php foreach ($data as $entity): ?>
                    <tr class="text-center" style="cursor: pointer;" 
                        ...
                        <td style="font-size: 15px">
                            <?php echo $entity['itemCod'] . ' - ' . $entity['itemName']; ?>
                        </td>
                        <td style="font-size: 15px">
                            <?php echo $entity['quantity']; ?>
                        </td>
                        <td style="font-size: 15px">
                            <?php echo $entity['new_quantity']; ?>
                        </td>
                        <td style="font-size: 15px">
                            <?php echo ($entity['control_type'] == '1') ? 'Entrada' : 'Saída'; ?>
                        </td>
